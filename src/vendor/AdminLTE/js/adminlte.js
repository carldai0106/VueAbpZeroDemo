 ...
 */
    (function($) {
        ...
        BoxWidget.prototype._setUpListeners = function() {
            ...
            $(this.element).on('click', this.options.removeTrigger, function(
                event
            ) {
                if (event) event.preventDefault();
                that.remove();
    ...
    (function($) {
        ...
        Layout.prototype.fix = function() {
            ...
            if ($('body').hasClass(ClassName.fixed)) {
                ...
                // we need not fix this in Dyh.Auth by carl commet 2017-11-26
    ...
    (function($) {
        ...
        Tree.prototype.collapse = function(tree, parentLi) {
            ...
            tree.slideUp(
                ...
                function() {
                    tree
                        .find(Selector.open + ' > ' + Selector.treeview)
                        .slideUp();
                    $(this.element).trigger(collapsedEvent);
                }.bind(this)
            );
